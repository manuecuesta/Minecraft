...
public class Estadisticas {
    ...
    public static void guardarEstadisticas(Partida partida, Paintball plugin, Player player) throws IOException {
        File estadisticas;
        if (stats == null) {
    ...
    public static int[] recuperarEstadisticas(Player player, Paintball plugin) {
        File estadisticas;
        if (stats == null) {
            statsfile = new File(plugin.getDataFolder(), "estadisticas.yml");
        }
